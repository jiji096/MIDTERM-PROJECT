/** 
    This is the CircleOutline class, which implements the DrawingObject interface and 
    uses the java.awt.geom package to draw the outline of a circle. It accepts x and y
    coordinates, a size parameter, and a color parameter to
    determine its position and appearance.
